...
public class AddDiscountCodeServlet extends HttpServlet {
    ...
    private final String ONLOAD_CARD = "OnloadCartPageServlet";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DiscountsDTO dto = dao.getDiscountInfo(discountCode);
            ...
            if(session != null) {
                ...
                if(discountCode == null || discountCode.equals("")) {
                    request.setAttribute("DELETE_CODE", "Delete");
                }
                else {
                    if(dto == null) {
                        ...
                        session.setAttribute("DISCOUNT_INFO", dto);
                    }
                }
            }
        }
        catch (NamingException ex) {
            Logger.getLogger(AddDiscountCodeServlet.class.getName()).log(Level.SEVERE, null, ex);
        } 
